    ...
    def generate(self, conv: List[Dict], 
        ...
        for _ in range(self.API_MAX_RETRY):  
            try:
                ...
                # )
                # print(json)
                resp = requests.post(self.API_HOST_LINK, json=json, headers={"Authorization": f"Api-Key {self.MODEL_API_KEY}"}, timeout=self.API_TIMEOUT)
                resp_json = resp.json()
...
class APIModelLlama7B(APIModel): 
    ...
    MODEL_API_KEY = "sk-shenqibaobei-llama-2-7b"
